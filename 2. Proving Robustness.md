...
$|\mathbf{x}|_{\infty} = max \mathbf{x}$. Used to measure a distance between two vectors, it will measure the maximum difference between any two given elements in the vectors (taken pairwise). 
