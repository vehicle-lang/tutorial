...
This property is often called _$\epsilon$-ball robusness_. 
 For every image in the dataset, we assume we can "draw" a small ball around it, and guarantee that within that ball classification of the network does not change much:
