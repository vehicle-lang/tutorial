...
1. Re-define the Classification and Standrad robustness by using some different notion of distance, e.g. Euclidean distance, instead of the $L_{\infty}$ norm. 

2. Try defining other forms of Robustness property from Casadio et al.

3. Download a Fashion MNIST data set, train the model, and verify its robustness.