...
Below, we shortcut a bit the calculation of the $|\mathbf{x}|_{\infty}$ being bounded by $\epsilon$
...
Download the [Fashion MNIST data set](<https://www.tensorflow.org/datasets/catalog/fashion_mnist>), train the model, and verify its robustness.