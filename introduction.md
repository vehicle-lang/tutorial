...
5. Finally, neural networks usually work as components of complex systems, and the question of smooth integation of neural networ solvers with other theorem provers requires resolution.
