...
Using the same `.vcl` file as in all previous exercises, define and verify in *Vehicle* the propety of _Standard Robustness_,
...
Use *Vehicle* to define other forms of Robustness property from Casadio et al. Check verification success rates for these properties.
...
*Please note: although Vehicle language is rather rich to allow such extensions, not all specifications will be feasile for Marabou that works with linear real arithmetic.*
