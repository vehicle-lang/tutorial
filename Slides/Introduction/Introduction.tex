...
%\end{center}
 \begin{columns}
   ...
   \includegraphics[width=1.3cm]{Images/Matthew.jpg}
      ...
      \begin{block}{\footnotesize{Matthew Daggitt}}
     \end{block}
    \includegraphics[width=1.5cm]{Images/RS.jpg}
   \begin{block}{\footnotesize{Rob Stewart}}
     \end{block}
  ...
  % \includegraphics[width=2cm]{photoDP.jpg}
   ...
   \begin{block}{\footnotesize{Wen Kokke}}
   \end{block}
...
% Set A
\node[rectangle,draw] (A) at (1.5,5) {Property in Vehicle};
...
\item Socrates [in Python]:  Given a spec and a network (in JSON), calls different NN verifiers.  
 ...
 \begin{thebibliography}{99}
 \beamertemplatearticlebibitems
\bibitem{1}{Long H. Pham, Jiaying Li, and Jun Sun. 2020. SOCRATES: Towards a Unified Platform for Neural Network Verification.
CoRR abs/2007.11206 (2020).}
 \end{thebibliography}}
 
 {\alert {\small Cons: $I^O$, $I^P$, $I^{\int}$, $E^G$}}
 ...
 \begin{thebibliography}{99}
 \beamertemplatearticlebibitems
\bibitem{1}{Dario Guidotti, Luca Pulina, and Armando Tacchella. 2020. NeVer 2.0: Learning, Verification and Repair of Deep Neural
Networks. CoRR abs/2011.09933 (2020).}
 \end{thebibliography}}
  
  {\alert {\small Cons: $I^O$ (partially), $I^P$, $I^{\int}$, $E^G$ }}
...
{\scriptsize
 \begin{thebibliography}{99}
 \beamertemplatearticlebibitems
\bibitem{1}{Julien Girard-Satabin, Michele Alberti, François Bobot, Zakaria Chihani, and Augustin Lemesle. 2022. CAISAR: A platform
for Characterizing Artificial Intelligence Safety and Robustness. In AISafety (CEUR-Workshop Proceedings). Vienne,
Austria.}
 \end{thebibliography}}

 {\alert {\small Cons: $I^O$, \xout{$I^P$}, \xout{$I^{\int}$}, $E^G$ }}
...
... and support community's effort towards resolution of Grand Challenges

\end{frame}

  \begin{frame}
  \frametitle{Which challenges Vehicle addresses}
  \footnotesize{
  \begin{itemize}
  \item Theory: finding appropriate verification properties
\item  Solvers: undecidability of non-linear real arithmetic  and scalability of neural network verifiers 
...
Vehicle: Interfacing Neural Network Verifiers with Interactive Theorem Provers. FOMLAS}

\bibitem{4}{Vehicle Team: The Vehicle language: \url{https://github.com/vehicle-lang} 2023.}

\bibitem{5}{M.Daggitt and W.Kokke: Vehicle User Manual. 2023.}
 \end{thebibliography}}
...
\begin{block}{}
\begin{itemize}
\item Introduce Vehicle specification language at the user level
