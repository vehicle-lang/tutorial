...
\author[Katya et al]{Ekaterina Komendantskaya and Matthew Daggitt and Wen Kokke and ...}
\institute[]{}
...
\end{frame}
 ...
 \begin{frame}
  \frametitle{Thank you for your attention! (Vehicle Team)}
...
\begin{frame}
\frametitle{}
  \begin{alertblock}{ How BIG is the problem?}
...
\begin{frame}
\frametitle{Recap: What are the problems?}

\pause
\begin{itemize}
\item Interoperability - properties are not portable between training/counter-example search/ verification.
\pause
\item Interpretability - code is not easy to understand.
\pause
\item Integration - properties of networks cannot be linked to larger control system properties. 
\end{itemize}
\end{frame}
...
\section{Introduction to Vehicle (a mini tutorial)}
...
\bibitem{1}{N. Slusarz, E. Komendantskaya, M. Daggitt, R. Stewart, K. Stark:
...
\bibitem{1}{Vehicle Team: The Vehicle language: \url{https://github.com/vehicle-lang} 2023.}

\bibitem{1}{M.Daggitt and W.Kokke: Vehicle User Manual. 2023.}
 \end{thebibliography}}}
