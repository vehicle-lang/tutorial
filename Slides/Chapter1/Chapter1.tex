...
\item Using neworks and data given in same folder, verify robustness via Vehicle.
\end{itemize}}
\end{block}
...
\item Using the neworks and data given in same folder, verify the properties via Vehicle.
\end{itemize}}
\end{block}
