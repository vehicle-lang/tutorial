...
On a more practical note, \* For Chapters 1, 2 and 3 you only need to 1.
Install *Vehicle* : just run `pip install vehicle-lang` 2. Install
Marabou: just run `pip install maraboupy`
